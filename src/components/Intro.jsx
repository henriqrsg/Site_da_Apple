    ...
    return (
        <section className="bg-black py-20 px-6">
            <div className="max-w-5xl mx-auto text-center">
                ...
                <p className="text-lg md:text-xl text-gray-300 mb-10 max-w-3xl mx-auto">O design mas refinado que já criamos. Titânio de grau aeroespacial. Chip A18 Pro. Sistema de câmera Pro revolucionário.</p>
            </div>
