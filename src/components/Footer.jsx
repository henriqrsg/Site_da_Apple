function Footer() {
    ...
    return (
        <footer className="bg-gray-900 border-t-2 border-gray-800" id="footer">
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="grid md:grid-cols-4 mb-8 gap-8">
                ...
                <div className="border-t-2 border-gray-800 pt-7 pb-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-md text-gray-300">Copyright © 2027 Apple Inc. Todos os direitos reservados.</p>
                        <div className="flex gap-6 text-sm text-gray-400">
                            {buttonLinks.map((link, index) => (
                                <a href="#" key={index} className="hover:text-white cursor-pointer">
                                    {link}
                                </a>
                            ))}
                        </div>
